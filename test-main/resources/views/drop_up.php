...
<body>
    ...
    <div class="trigger" id="trigger-profile" style="position: relative; width: 100%;">
        <div class="text-center mb-4" style="cursor: pointer;">
            <img src="../Imagens/bluesky.svg" class="rounded-circle mt-5" alt="User" width="60">
            <a href="perfil.php"><p class="mt-2 mb-0"></p>Marival</a>
